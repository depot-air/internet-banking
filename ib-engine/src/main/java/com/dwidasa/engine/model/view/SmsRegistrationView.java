 ...
 * Date: 9/4/12
 */
public class SmsRegistrationView implements BaseView {
    ...
    private String tinUssd;
    private String encryptedTinUssd;
    ...
    public String getTinUssd() {
        return tinUssd;
    }

    public void setTinUssd(String tinUssd) {
        this.tinUssd = tinUssd;
    }

    public String getEncryptedTinUssd() {
        return encryptedTinUssd;
    }

    public void setEncryptedTinUssd(String encryptedTinUssd) {
        this.encryptedTinUssd = encryptedTinUssd;
    }
