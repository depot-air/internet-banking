...
import com.dwidasa.engine.service.view.CashToBankDelimaViewService;
 ...
 * Time: 5:44 PM
 */
@Service("cashToBankDelimaViewService")
public class CashToBankDelimaViewServiceImpl implements CashToBankDelimaViewService {
    ...
    public CashToBankDelimaViewServiceImpl() {
    ...
    private class InquiryMessageCustomizer implements MessageCustomizer {
        ...
        public void compose(BaseView view, Transaction transaction) {
            ...
            customData += String.format("%1$-25s", "00");
            ...
            //-- reference an(16) left justified padding with space
...
//            customData += cv.getReceiverGender();
        ...
        public Boolean decompose(Object view, Transaction transaction) {
            ...
            cv.setBillerReference(bit48.substring(65, 81));
    ...
    private class TransactionMessageCustomizer implements MessageCustomizer {
        ...
        public void compose(BaseView view, Transaction transaction) {
            ...
            customData += String.format("%012d", 0);
            //-- reference an(16) left justified padding with space
            customData += String.format("%1$-16s", cv.getBillerReference());
        ...
        public Boolean decompose(Object view, Transaction transaction) {
        	...
        	//1:L:0:reprint-counter
            CashInDelimaView cv = (CashInDelimaView) view;
            cv.setBillerReference(transaction.getFreeData1().substring(65, 81).trim());		//(65, 77).trim());
