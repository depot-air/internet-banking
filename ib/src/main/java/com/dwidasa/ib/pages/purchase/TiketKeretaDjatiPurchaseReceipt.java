...
public class TiketKeretaDjatiPurchaseReceipt {
	private Logger logger = Logger
			.getLogger(TiketKeretaDjatiPurchaseReceipt.class);
	@Property
	...
	public void setupRender() {
		...
		sessionManager
				.setSessionLastPage(TiketKeretaDjatiPurchaseReceipt.class
						.toString());
		setTokenType();
		chooseValue = "fromId";
		// setTokenType();
	...
	public String getPenumpang(){
		if(totalKursi > 1){
			return tiketKeretaDjatiPurchaseView.getNamaPenumpang1()+" / "+tiketKeretaDjatiPurchaseView.getNoKursiPenumpang1()+" ,"+tiketKeretaDjatiPurchaseView.getNamaPenumpang2()+" / "+tiketKeretaDjatiPurchaseView.getNoKursiPenumpang2();
		}else
			return tiketKeretaDjatiPurchaseView.getNamaPenumpang1()+" / "+tiketKeretaDjatiPurchaseView.getNoKursiPenumpang1();
		//return "";
	}
