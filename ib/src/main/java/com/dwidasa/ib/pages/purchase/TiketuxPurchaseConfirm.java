...
public class TiketuxPurchaseConfirm {
	private Logger logger = Logger
			.getLogger(TiketuxPurchaseConfirm.class);
	@Property
	...
	@InjectPage
	private TiketuxPurchaseReceipt djatiPurchaseReceipt;
	...
	public void setupRender() {
		...
		sessionManager
				.setSessionLastPage(TiketuxPurchaseConfirm.class
						.toString());
		setTokenType();
		chooseValue = "fromId";
	...
	void onValidateFromForm() {
        ...
        try {
            if (otpManager.validateToken(tiketKeretaDjatiPurchaseView.getCustomerId(), this.getClass().getSimpleName(), tokenView)) {
