...
public class TvPaymentReceipt {
    ...
    public void setupRender() {
    	sessionManager.setSessionLastPage(TvPaymentReceipt.class.toString());
    	sessionManager.setSmsTokenSent(false);
        if (tvPaymentView.getResponseCode() != null && tvPaymentView.getResponseCode().equals(com.dwidasa.ib.Constants.SUCCESS_CODE)) {
    ...
    public TvPaymentView getTvPaymentView() {
        return tvPaymentView;
    }
    ...
    public boolean isFinnet() {
    	if (tvPaymentView.getProviderCode().equals(com.dwidasa.engine.Constants.PROVIDER_FINNET_CODE) && tvPaymentView.getBillerCode().equals(Constants.TELKOM_VISION)) {
    		return true;
    	}
    	return false;
    }
