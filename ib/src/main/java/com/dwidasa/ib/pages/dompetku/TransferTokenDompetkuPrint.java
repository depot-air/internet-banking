 ...
 * Time: 9:56
 */
public class TransferTokenDompetkuPrint extends BasePrintPage {
    @Inject
    ...
    @InjectPage
    private TransferTokenDompetkuReceipt tarikTunaiDompetkuReceipt;
    ...
    void setupRender() {
        ...
        cashInDompetkuView = tarikTunaiDompetkuReceipt.getCashInDompetkuView();
    }
}
