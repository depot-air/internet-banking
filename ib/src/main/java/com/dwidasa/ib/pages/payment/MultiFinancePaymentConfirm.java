 ...
 * Time: 22:43
 */
public class MultiFinancePaymentConfirm {
    @Property
    @Persist
    ...
    @InjectPage
    private MultiFinancePaymentReceipt multiFinancePaymentReceipt;
    ...
    public void onPrepare() {
    	...
    	sessionManager.setSessionLastPage(MultiFinancePaymentConfirm.class.toString());
		if (tokenView == null) {
