...
public class TiketKeretaDjatiPurchaseRegistration {
	private Logger logger = Logger
			.getLogger(TiketKeretaDjatiPurchaseRegistration.class);
	@Property
	...
	@InjectPage
	private TiketKeretaDjatiPurchaseConfirm djatiPurchaseConfirm;
	...
	public void setupRender() {
		...
		sessionManager
				.setSessionLastPage(TiketKeretaDjatiPurchaseRegistration.class
						.toString());
		chooseValue = "fromId";
	...
	public Object onSuccess() {
		 ...
		 djatiPurchaseConfirm.setVehicleCode(getVehicleCode());
