 ...
 * Time: 22:43
 */
public class TarikTunaiDompetkuInput {
    ...
    @InjectPage
    private TarikTunaiDompetkuConfirm tarikTunaiDompetkuConfirm;
    ...
    public void setupRender() {
    	sessionManager.setSessionLastPage(TarikTunaiDompetkuInput.class.toString());
...
//        		cashInDompetkuView.getBillerCode()).get(0).getProductName());
        ...
        cashInDompetkuView.setTransactionType(Constants.DOMPETKU_CASH_OUT);
    }
...
//        {
//            //if(billerProduct.getBillerId().equals((long)6))
//            //{
