...
public class TiketuxPurchaseJurusan {
	private Logger logger = Logger.getLogger(TiketuxPurchaseJurusan.class);
    @Property
    ...
    @InjectPage
    private TiketuxPurchaseKursi djatiPurchaseKursi;
    ...
    public void setupRender() {
    	...
    	sessionManager.setSessionLastPage(TiketuxPurchaseJurusan.class.toString());
        chooseValue = "fromId";
        //setTokenType();
  ...
  //@DiscardAfter
    Object onViewStatement(String kodeJurusan, BigDecimal amount, String departId, String tipeKendaraan) {
...
//    	}
    	...
    	System.out.println("Kode Jurusan "+kodeJurusan.substring(kodeJurusan.lastIndexOf("-")));
		...
		for (int i = 0; i < getLocation().size(); i++) {
			...
			if (lokasi.substring(0, 6).equals(kodeJurusan.substring(0, 6))) {

				TiketKeretaDjatiPurchaseView temp = new TiketKeretaDjatiPurchaseView();
				temp.setLokasiKeberangkatan(lokasi);
    	...
    	djatiPurchaseKursi.setProductCode(getProductCode());
    	djatiPurchaseKursi.setVechileCode(tipeKendaraan);
