 ...
 * Time: 22:44
 */
public class TrainPaymentReceipt {
    @Persist
    ...
    public void setupRender() {
    	sessionManager.setSessionLastPage(TrainPaymentReceipt.class.toString());
    	sessionManager.setSmsTokenSent(false);
        if (trainPaymentView.getResponseCode() != null && trainPaymentView.getResponseCode().equals(Constants.SUCCESS_CODE)) {
    ...
    public TrainPaymentView getTrainPaymentView() {
        return trainPaymentView;
    }
    ...
    public String getStatusDetil(){
    	...
    	try {
			...
			if (trainPaymentView.getResponseCode() != null && trainPaymentView.getResponseCode().equals(com.dwidasa.ib.Constants.SUCCESS_CODE)) {
	            status = messages.get("success");
	        } else {
	            status = messages.get("failed");
	        }
