 ...
 * Time: 22:43
 */
public class TransferTokenDompetkuConfirm {
    ...
    @InjectPage
    private TransferTokenDompetkuReceipt dompetkuReceipt;
    ...
    public void setupRender() {
    	sessionManager.setSessionLastPage(TransferTokenDompetkuConfirm.class.toString());
        setTokenType();
    }
