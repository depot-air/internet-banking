...
public class CustomClasspathURLConverter implements ClasspathURLConverter {
    private static Logger logger = Logger.getLogger(CustomClasspathURLConverter.class);
